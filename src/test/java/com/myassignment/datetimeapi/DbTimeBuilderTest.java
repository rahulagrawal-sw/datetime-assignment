...
public class DbTimeBuilderTest {
    ...
    public void validTime1WithValidPattern() {
        ...
        DbTime result = TimeTimeBuilder.buildTime("11:10:20", DbAmPm.AM, "hh", "mm", "ss");
        Assertions.assertEquals("Eleven Hours Ten Minutes Twenty Seconds Morning", result.toString());
    }
    ...
    public void validTime2WithValidPattern() {
        DbTimeBuilder TimeTimeBuilder = new DbTimeBuilder();
        DbTime result = TimeTimeBuilder.buildTime("09:59:59", DbAmPm.AM, "hh", "mm", "ss");
        Assertions.assertEquals("Nine Hours FiftyNine Minutes FiftyNine Seconds Morning", result.toString());
    }
    ...
    public void validTime3WithValidPattern() {
        DbTimeBuilder TimeTimeBuilder = new DbTimeBuilder();
        DbTime result = TimeTimeBuilder.buildTime("00:00:29", DbAmPm.AM, "hh", "mm", "ss");
        Assertions.assertEquals("Zero Hours Zero Minutes TwentyNine Seconds Morning", result.toString());
    }
    ...
    public void validTime4WithValidPattern() {
        DbTimeBuilder TimeTimeBuilder = new DbTimeBuilder();
        DbTime result = TimeTimeBuilder.buildTime("03:06:09", DbAmPm.PM, "hh", "mm", "ss");
        Assertions.assertEquals("Three Hours Six Minutes Nine Seconds Evening", result.toString());
    }
    ...
    public void validTimeWithInValidPattern1() {
        ...
        Assertions.assertThrows(DbNoSuchSupportedDateTimePatternException.class,
                () -> TimeTimeBuilder.buildTime("03:06:09", DbAmPm.AM, "HH", "mm", "ss"));
    }
    ...
    public void validTimeWithInValidPattern2() {
        DbTimeBuilder TimeTimeBuilder = new DbTimeBuilder();
        Assertions.assertThrows(DbNoSuchSupportedDateTimePatternException.class,
                () -> TimeTimeBuilder.buildTime("03:06:09", DbAmPm.AM, "dd", "MM", "ss"));
    }
    ...
    public void inValidTime1WithValidPattern() {
        ...
        Assertions.assertThrows(DbDateTimeParseException.class,
                () -> TimeTimeBuilder.buildTime("01-10:21", DbAmPm.AM, "hh", "mm", "ss"));
    }
    ...
    public void inValidTime2WithValidPattern() {
        ...
        Assertions.assertThrows(DbDateTimeException.class,
                () -> TimeTimeBuilder.buildTime("13:10:21", DbAmPm.AM, "hh", "mm", "ss"));
    }
    ...
    public void inValidTime3WithValidPattern() {
        DbTimeBuilder TimeTimeBuilder = new DbTimeBuilder();
        Assertions.assertThrows(DbDateTimeException.class,
                () -> TimeTimeBuilder.buildTime("01:61:21", DbAmPm.AM, "hh", "mm", "ss"));
    }
    ...
    public void inValidTime4WithValidPattern() {
        DbTimeBuilder TimeTimeBuilder = new DbTimeBuilder();
        Assertions.assertThrows(DbDateTimeException.class,
                () -> TimeTimeBuilder.buildTime("01:10:65", DbAmPm.AM, "hh", "mm", "ss"));
    }
}
